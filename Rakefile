...
namespace :deploy do
  task :acc do
    exec "SITE=acc S3_BUCKET=sandbox.austinconventioncenter.com s3_website push --site=_site/acc"
  end

  task :pec do
    exec "SITE=pec S3_BUCKET=sandbox.palmereventscenter.com s3_website push --site=_site/pec"
  end
