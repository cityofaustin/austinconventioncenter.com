...
namespace :deploy do
  task :acc do
    exec "S3_BUCKET=alpha.austinconventioncenter.com s3_website push --site=_site/acc"
  end

  task :pec do
    exec "S3_BUCKET=beta.palmereventscenter.com s3_website push --site=_site/pec"
  end
end
